    ...
    <div class="wraper">
        ...
        <div class="form--register">
            <div class="form--register__title">
                <h1>Đăng kí</h1>
                <p>Nếu bạn chưa có tài khoản, đăng kí tại đây</p>
            </div>
            <form action="signup" method="post" class="form--container">
                <div class="name">
                    <h1 class="text">Tên tài khoản</h1>
                    <input class="input" type="text" placeholder="xin vui lòng nhập tên của bạn" name="user-name">
                </div>
                <div class="password">
                ...
                <div class="phone--number">
                    <h1 class="text">Số điện thoại</h1>
                    <input class="input" type="text" placeholder="xin vui lòng nhập số điện thoại" name="phone">
                </div>
                <div class="e-mail">
            ...
            <div class="form--footer">
                <div class="link--register">Bạn đã có tài khoản?</div>
