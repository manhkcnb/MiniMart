...
public class Product {
    ...
    public String toString() {
        return "Product{" + "id=" + id + ", productName=" + productName + ", productImg=" + productImg + ", price=" + price + ", description_1=" + description_1 + ", description_2=" + description_2 + ", description_3=" + description_3 + ", origin=" + origin + ", category_id=" + category_id + '}';
    }
